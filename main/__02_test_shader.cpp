...
//TIMES : (pour 50k cubes - DrawCulling)
// None : 5.623ms
// SQRT : 6.408ms
// ASIN :
...
#ifdef SQRT
	cubeShaderProgram.CompileSource("shaders/__02_test_shader/cube.vert", "shaders/__02_test_shader/cube_sqrt.frag");
#else
#ifdef ASIN
	cubeShaderProgram.CompileSource("shaders/__02_test_shader/cube.vert", "shaders/__02_test_shader/cube_asin.frag");
#else
	cubeShaderProgram.CompileSource("shaders/__02_test_shader/cube.vert", "shaders/__02_test_shader/cube_grayscale.frag");
#endif
#endif
...
#else
	rmt_ScopedOpenGLSample(DrawCubes);
...
void HelloCullingDrawingProgram::UpdateUi()
{
	...
	ImGui::SliderInt("Cube Numbers", &cubeLength, 100, cubeLength);
}
