...
Default font is loaded if you don't pass `false` in `ImGui::SFML::Init`. Call `ImGui::SFML::CompileSource(window, false);` if you don't want default font to be loaded.
